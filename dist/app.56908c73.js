...
function updateSlidesClasses() {
  ...
  if (activeSlide) {
    if (!gridEnabled) {
      // Next Slide
      nextSlide = (0, _utils.p)(activeSlide, ".".concat(params.slideClass, ", swiper-slide"))[0];
      if (params.loop && !nextSlide) {
        nextSlide = slides[0];
      }

      // Prev Slide
      prevSlide = (0, _utils.q)(activeSlide, ".".concat(params.slideClass, ", swiper-slide"))[0];
